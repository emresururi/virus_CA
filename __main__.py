...
class cell(object):
    ...
    def move(self):
        ...
        if grid_bl.get_xy(gidecegi_yer[0], gidecegi_yer[1]).state == 6 or grid_bl.get_xy(gidecegi_yer[0],
                                                                                         gidecegi_yer[1]).state == 6:
            if self.y >= -2:
        ...
        if grid_bl.get_xy(gidecegi_yer[0], gidecegi_yer[1]).state == 3 or grid_bl.get_xy(gidecegi_yer[0], gidecegi_yer[
            1]).state == 5 and self.state == 4:
            if self.y >= -2:
            ...
            self.komsular = [ll for ll in self.komsular if not (ll == gidecegi_yer).all()]
        ...
        elif grid_bl.get_xy(gidecegi_yer[0], gidecegi_yer[1]).state == 2 and grid_bl.get_xy(gidecegi_yer[0],
                                                                                            gidecegi_yer[
                                                                                                1]).state == 3 and grid_bl.get_xy(
            gidecegi_yer[0], gidecegi_yer[1]).state == 4 and grid_bl.get_xy(gidecegi_yer[0],
                                                                            gidecegi_yer[1]).state == 5:
            # self.komsular.remove(gidecegi_yer)
            self.komsular = [ll for ll in self.komsular if not (ll == gidecegi_yer).all()]
            new_pos = random.choice(self.komsular)
            print("yasak konum silindi ve yeni konum seçildi")
